...
export type {
  ...
  CheckItemProps as MenuCheckItemProps,
  CheckItemRenderProps as MenuCheckItemRenderProps,
  ...
  RadioItemRenderProps as MenuRadioItemRenderProps,
  RootClassNameProps as MenuRootClassNameProps,
...
export * from "./PortalConfigProvider";
...
export type {
  ...
  TabRenderProps as TabGroupTabRenderProps,
} from "./TabGroup";
